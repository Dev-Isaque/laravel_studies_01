...
use App\Http\Controllers\AulasRoutesController;
use App\Http\Controllers\AulaRoutesUserController;
...
Route::get('/index', [AulasRoutesController::class, 'index']);
Route::get('/about', [AulasRoutesController::class, 'about']);
...
Route::get('/valor/{value}', [AulasRoutesController::class, 'mostrarValor']);
Route::get('/valores/{value1}/{value2}', [AulasRoutesController::class, 'mostrarValores']);
Route::get('/valores2/{value1}/{value2}', [AulasRoutesController::class, 'mostrarValores']);

Route::get('/opcional/{value?}', [AulasRoutesController::class, 'mostrarValorOpcional']);
Route::get('/opcional1/{value1}/{value2?}', [AulasRoutesController::class, 'mostrarValoresOpcional']);

Route::get('/user/{user_id}/post/{post_id}', [AulasRoutesController::class, 'mostrarPosts']);
...
Route::prefix('admin')->group(function () {
    /*
        ...
        /admin/management
    */
    Route::get('/home', [AulasRoutesController::class, 'index']);
    Route::get('/about', [AulasRoutesController::class, 'about']);
    Route::get('/management', [AulasRoutesController::class, 'mostrarValor']);
});
...
Route::controller(AulaRoutesUserController::class)->group(function () {
